...
public final class AttributeUtils {
    ...
    public static XSString buildStringAttributeValue(String value) {
    ...
    private static <T extends XMLObject> T buildAttributeValue(XMLObjectBuilder<T> builder, QName typeName) {
        return builder.buildObject(new QName("urn:oasis:names:tc:SAML:2.0:assertion", "AttributeValue", "saml"), typeName);
    }
